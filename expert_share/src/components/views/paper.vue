            ...
            <el-row>
              <el-col :span=15>
                <el-row type="flex" justify="left">
                  <p style="font-family: 微软雅黑;line-height: 35px;font-size: 24px;font-weight: 400;color: rgb(66, 125, 201)">&nbsp;{{paper.c_title}}</p>
                </el-row>

                <el-row type="flex" justify="left">
                  <p style="font-family: 宋体;line-height: 27px;font-size: 14px;font-weight: 400;color: rgb(142, 142, 142)">&nbsp;{{paper.e_title}}</p>
                </el-row>
                <br/>
                <el-row type="flex" justify="left">
                  <el-col :span=3>
                ...
                <el-row>
                  <Card style="width:640px">
                    <div style="text-align:left">
                      ...
                      {{paper.c_periodical}}
                      <br/><br/>
                      <span style="font-family: 微软雅黑;font-size: 14px;color:RGB(137,137,137);font-weight: 700">Journal:</span>
                      {{paper.e_periodical}}
                      <br/><br/>
                      <span style="font-family: 微软雅黑;font-size: 14px;color:RGB(137,137,137);font-weight: 700">年，卷（期）:</span>
                      {{paper.indexid}}
                      <br/><br/>
                      <span style="font-family: 微软雅黑;font-size: 14px;color:RGB(137,137,137);font-weight: 700">在线出版日期:</span>
                      {{paper.time}}
                      <br/><br/>
              ...
              <el-col :span=9>
                <el-row type="flex" justify="left">
                  <p style="font-family: 微软雅黑;line-height: 35px;font-size: 24px;font-weight: 400;color: rgb(66, 125, 201)">推荐文章</p>
                  <br/>
                </el-row>
                <el-row>
                  <br/><br/>
