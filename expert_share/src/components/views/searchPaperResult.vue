        ...
        <Layout :style="{padding: '0 50px'}">
          <Sider hide-trigger :style="{background: '#fff'}">
            <classification :papers="papers" :keyword="input_keyword"
                            ...
                            :by_author="by_author" :by_year="by_year" :which_author="which_author"
          ...
          <Content :style="{padding: '24px', minHeight: '280px', background: '#fff'}">
            ...
            <paper_result v-if="paper_result_flag==true" ref="paper_result" :page="page_id" :keyword="input_keyword"
                          :papers="papers"></paper_result>
            <Page :total="paper_cnt" :page-size="10" :current="page_id" show-elevator show-total
